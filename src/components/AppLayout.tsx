...
const NAV: Record<Role, NavItem[]> = {
  employee: [
    ...
    { to: "/dashboard/my-goals/create", label: "Create Goals", icon: Target },
    { to: "/dashboard/my-goals", label: "My Goals", icon: ClipboardCheck },
    { to: "/dashboard/check-ins", label: "Check-ins", icon: CheckSquare },
    { to: "/dashboard/reports", label: "Reports", icon: FileBarChart },
  ],
  manager: [
    { to: "/dashboard", label: "Dashboard", icon: LayoutDashboard },
    { to: "/dashboard/team", label: "My Team", icon: Users },
    { to: "/dashboard/approvals", label: "Goal Approvals", icon: ClipboardCheck },
    { to: "/dashboard/check-ins", label: "Check-ins", icon: CheckSquare },
    { to: "/dashboard/reports", label: "Reports", icon: FileBarChart },
  ],
  admin: [
    { to: "/dashboard", label: "Dashboard", icon: LayoutDashboard },
    { to: "/dashboard/admin/cycles", label: "Cycle Management", icon: CalendarRange },
    { to: "/dashboard/admin/completion", label: "Completion Status", icon: ClipboardCheck },
    { to: "/dashboard/admin/audit", label: "Audit Trail", icon: History },
    { to: "/dashboard/admin/escalations", label: "Escalations", icon: ShieldAlert },
    { to: "/dashboard/reports", label: "Reports", icon: FileBarChart },
